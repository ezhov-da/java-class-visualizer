...
public class Class_ extends ParameterizableElement {
    ...
    public String getPackageName() {
        ...
        int i = originalTypeName.lastIndexOf('.');
        if (i != -1) {
            package_ = originalTypeName.substring(0, i);
        }
        return package_;
    }

    public Map<RelationDirection, Map<RelationType, Collection<Class_>>> getRelationsMap() {
        return relationsMap;
    }
}
